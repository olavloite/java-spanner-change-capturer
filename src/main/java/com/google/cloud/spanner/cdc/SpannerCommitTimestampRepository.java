...
/**
 * {@link CommitTimestampRepository} that stores the last seen commit timestamp for a table in a Cloud Spanner database table. The default table definition to use is
 * <code>
