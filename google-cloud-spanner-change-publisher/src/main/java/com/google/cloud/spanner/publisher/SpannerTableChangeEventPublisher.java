 ...
 *
 * <p>The changes to the table are emitted from a {@link SpannerTableChangeCapturer} and then sent
 * to Pub/Sub by this event publisher.
 */
public class SpannerTableChangeEventPublisher {
   ...
   * {@link SpannerTableChangeCapturer} as its source.
   */
  public static Builder newBuilder(SpannerTableChangeCapturer capturer) {
